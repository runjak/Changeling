...
$ft["settings"]["MAXSIZE"]		   = 6400000000; // Maximum file upload size - in bytes.
...
$ft["settings"]["SHOWDATES"]		 = 'Y-m-d'; // Set to a date format to display last modified date (e.g. 'Y-m-d'). See http://dk2.php.net/manual/en/function.date.php 
...
# Colours #
$ft["settings"]["COLOURONE"]		 = "#FFAAAA"; // Dark background colour - also used on menu links.
$ft["settings"]["COLOURONETEXT"]	 = "#FFFFEE"; // Text for the dark background.
$ft["settings"]["COLOURTWO"]		 = "#FFDDDD"; // Brighter color (for table rows and sidebar background).
$ft["settings"]["COLOURTEXT"]		= "purple"; // Regular text colour.
$ft["settings"]["COLOURHIGHLIGHT"]   = "#FFFFCC"; // Hightlight colour for status messages.

# Plugin settings #
$ft["plugins"]["search"] = TRUE;
$ft["plugins"]["edit"] = array(
 "settings" => array(
   "editlist" => "txt html htm css js php",
   "converttabs" => FALSE
 )
);
/*
